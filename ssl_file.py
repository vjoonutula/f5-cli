...
'''
    ...
    # python ssl_profile.py --host 1b.dev.b.chicken.net \
            --partition CI_Engineers --name web.b.chicken.net

    Configure a profile with the defaults but use a different parent profile
    # python ssl_profile.py --host f5-1b.dev.ord1.chicken.net \
            --partition CI_Engineers --name web.b.chicken.net \
            --default_profile /Common/clientssl-insecure-compatible

    # Configure SSL profile with a CA chain
    # python ssl_profile.py --host 1b.dev.b.chicken.net \
            --partition /CI_Engineers --name feeds.chicken.com \
